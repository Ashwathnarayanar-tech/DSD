        ...
        mblsubmit: function(eve) {
            ...
            if (productId) {
              ...
              if (existingLineItem && existingLineItem.length>0) {
                    ...
                    api.request("post","/rof/get_dates",{data:productId,customerId:require.mozuData('user').accountId}).then(function(productDetails){
                        if(productDetails==="item not found"){
                            ...
                            var futureDate,
                                ...
                                isHeatSensitive = productDetails.data.isheatSensitiveData;
