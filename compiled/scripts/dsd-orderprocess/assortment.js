          ...
          if(!$(e.currentTarget).hasClass("active")){
            try
            {
              if(!isApiCalled){
                ...
                isApiCalled = true;
                api.request('POST','svc/dsdassortments?categoryId='+catCode,{customerId:require.mozuData('user').accountId}).then(function(result){
    ...
    $(document).ready(function(event){
      ...
      /*
        ...
        var searchItemsFn = _.debounce(function(term) {
            api.request('POST','svc/customsearch',{"query":term,customerId:require.mozuData('user').accountId}).then(function(response){
